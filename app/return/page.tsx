...
export default function ReturnPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const picked = returnMessages[Math.floor(Math.random() * returnMessages.length)];
  ...
  <div className="mt-16 space-y-12">
    ...
    <div className="border-t border-white/10 pt-12 space-y-12">
      ...
      <div className="border-l-2 border-[#d7ba7d]/40 pl-6">
        <p className="text-[#d7ba7d] text-xl font-serif leading-9 italic">
      ...
      <p className="text-sm text-white/40 pt-4 leading-7">
        Stay with what you chose.
        <br />
